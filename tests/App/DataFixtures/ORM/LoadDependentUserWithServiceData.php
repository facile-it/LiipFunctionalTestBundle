...
namespace Facile\SymfonyFunctionalTestCase\Tests\App\DataFixtures\ORM;
...
class LoadDependentUserWithServiceData extends AbstractFixture implements DependentFixtureInterface
{
    ...
    {
        return [
            'Facile\SymfonyFunctionalTestCase\Tests\App\DataFixtures\ORM\LoadUserWithServiceData',
        ];
    }
}
